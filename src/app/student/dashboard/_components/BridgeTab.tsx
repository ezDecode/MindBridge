...
function MoodTooltip({
  ...
  return (
    <div className="rounded-[1.2rem] border border-[var(--color-border)] bg-white/95 px-4 py-3 shadow-[0_20px_40px_rgba(45,41,38,0.12)] backdrop-blur-md">
    ...
    <div className="flex h-full min-h-0 flex-col bg-[linear-gradient(180deg,color-mix(in_srgb,var(--color-surface-warm),white_18%)_0%,var(--color-surface)_18rem)]">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <div className="rounded-[1.9rem] border border-[var(--color-border)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--color-primary-light),white_28%)_0%,var(--color-surface)_100%)] p-6 sm:p-7">
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {metrics.map((metric, index) => (
                ...
                >
                  <Card interactive variant="default" padding="sm" className="h-full bg-white/80">
                    <div className="flex items-center justify-between gap-3">
                      <Text as="p" variant="small" weight="medium" className="text-[var(--color-text-secondary)]">
                        {metric.label}
                      </Text>
                      <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[var(--color-surface-warm)] text-[var(--color-primary)] shadow-sm">
                        {metric.icon}
                      </div>
                    </div>
...
function SnapshotRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between rounded-[1.1rem] bg-white px-4 py-3 shadow-sm transition-transform hover:scale-[1.01]">
      <Text as="p" variant="small" weight="medium" className="text-[var(--color-text-secondary)]">
        {label}
      </Text>
      <Text as="p" variant="small" weight="bold" className="text-[var(--color-text-primary)]">
...
function CompactAction({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group rounded-[1.25rem] border border-[var(--color-border)] bg-white p-4 text-left transition-all duration-200 ease-[var(--ease-out)] hover:border-[var(--color-border-strong)] hover:bg-[var(--color-surface-warm)] active:scale-[0.97]"
    >
      <div className="flex items-start gap-3">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[var(--color-surface-warm)] text-[var(--color-primary)] shadow-sm transition-transform group-hover:scale-110">
          {icon}
        </div>
        <div className="min-w-0">
          <Text as="p" variant="small" weight="bold" className="text-[var(--color-text-primary)]">
