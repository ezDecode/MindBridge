      ...
      <AnimatePresence>
        {sidebarOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[var(--action-primary)]/40 backdrop-blur-[2px] lg:hidden"
          />
        )}
      </AnimatePresence>

      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[min(18rem,85vw)] flex-col border-r border-[var(--border-default)] bg-[var(--bg-sidebar)] transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] lg:static lg:block lg:w-[16rem] lg:shrink-0 lg:translate-x-0 ${
        ...
        <div className="flex h-full flex-col px-4 pb-4">
          ...
          <div className="mb-6">
            ...
            >
              ...
              New Session
              <div className="ml-auto flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[10px] font-bold text-[var(--text-icon)] bg-[var(--bg-hover)] ring-1 ring-inset ring-[var(--border-default)]">
            ...
            <div className="mb-2">
              ...
              <nav className="flex flex-col gap-0.5">
               <button
                  ...
                  className="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-[13.5px] font-medium text-[var(--text-muted)] transition-colors hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)]"
                >
                  <div className="flex h-5 w-5 items-center justify-center text-[var(--text-icon)]">
             ...
             <Link href="/student/settings" className="group flex w-full items-center justify-between rounded-xl px-2 py-2 transition-all hover:bg-[var(--surface-default)] hover:shadow-lg hover:ring-1 hover:ring-inset hover:ring-[var(--border-default)]">
               <div className="flex items-center gap-2.5">
                 ...
                 <div className="flex flex-col items-start justify-center">
                   <span className="text-[14px] font-bold text-[var(--text-primary)] leading-tight">{userName}</span>
                   <span className="text-[11px] font-semibold tracking-wide text-[var(--text-icon)] mt-0.5 leading-tight">STUDENT</span>
                 </div>
               </div>
