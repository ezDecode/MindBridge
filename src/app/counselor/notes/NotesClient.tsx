        ...
        <div className="lg:col-span-4 flex flex-col gap-4 overflow-hidden bg-surface rounded-xl border border-border p-4">
          <div className="relative shrink-0">
            ...
            <input 
              ...
              className="w-full bg-background border border-border rounded-md pl-10 pr-4 py-2 text-sm focus:border-white/20 transition-all text-white placeholder:text-text-dim outline-none"
            />
          </div>
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar space-y-2 pr-1">
            {initialBookings.length === 0 ? (
              <div className="p-8 text-center text-text-dim">
                <Icon icon="tabler:history-off" className="text-3xl mx-auto mb-2 opacity-50" />
                <span className="text-[10px] font-medium ">No past sessions</span>
              </div>
            ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <Text weight="semibold" className="text-sm truncate text-white mb-1">{studentName}</Text>
                      <Text variant="small" className="text-[10px] font-medium text-text-dim block">
        ...
        <div className="lg:col-span-8 flex flex-col h-full">
          {selectedBooking ? (
            <Card padding="none" className="bg-surface border-border flex-1 flex flex-col overflow-hidden relative shadow-premium">
              ...
              <div className="px-6 py-5 border-b border-white/5 bg-white/[0.02] flex items-center justify-between shrink-0">
                <div>
                  ...
                  <div className="flex items-center gap-3 text-[10px] font-medium text-text-dim ">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-medium text-success hidden sm:inline">End-to-End Encrypted</span>
                </div>
              </div>
              ...
              <div className="flex-1 p-6 relative">
                <textarea
                  ...
                  className="w-full h-full bg-transparent resize-none outline-none text-sm text-white placeholder:text-text-dim leading-relaxed"
                />
              </div>

              {/* Footer */}
              <div className="p-4 border-t border-white/5 bg-background/50 flex items-center justify-between shrink-0">
                <Text variant="small" className="text-[10px] font-medium text-text-dim flex items-center gap-2">
            ...
            <div className="flex-1 flex flex-col items-center justify-center border border-dashed border-white/5 rounded-xl bg-white/[0.01] text-text-dim">
              <Icon icon="tabler:note-off" className="text-4xl mb-4 opacity-50" />
