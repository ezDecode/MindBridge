...
const Chip = forwardRef<HTMLSpanElement, ChipProps>(
  ({ className = "", variant = "default", size = "md", children, ...props }, ref) => {
    const base = "inline-flex items-center justify-center px-3.5 text-span font-semibold rounded-full transition-colors duration-150 ease-out transition-transform duration-150 ease-out touch-manipulation";
    const variants = {
