...
const Card = forwardRef<HTMLDivElement, CardProps>(
 ...
 <div
 ref={ref}
 className={`rounded-md transition-[border-color,background-color,transform,box-shadow] duration-200 ease-[var(--ease-out)] ${variants[variant]} ${paddings[padding]} ${interactive ? "hover:border-[var(--color-border-strong)] hover:shadow-sm active:scale-[0.99]" : ""} ${className}`}
 {...props}
 >
 {children}
 </div>
