...
const footerNavigation = {
  tools: [
    ...
    { href: "/student/quizzes", label: "Wellness Screening", icon: FiActivity },
  ...
  support: [
    ...
    { href: "/admin/dashboard", label: "Admin Dashboard", icon: FiShield },
  ],
};
          ...
          <div className="relative">
            <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
              ...
              <div className="max-w-[42rem]">
                ...
                <Text as="h2" variant="h3" weight="bold" className="mt-6 text-[var(--color-text-primary)] leading-tight">
                  Life-changing habits start with a single calm conversation.
                </Text>
                <Text as="p" variant="body" className="mt-4 max-w-[45ch] text-[var(--color-text-secondary)] leading-relaxed">
            ...
            {/* Copyright & Meta */}
            <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-[var(--color-border-warm)]/60 pt-6 sm:flex-row">
