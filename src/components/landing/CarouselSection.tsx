...
const Slide = ({ children }: SlideProps) => {
 return (
 <div className="flex-shrink-0 w-full px-4 flex justify-center">
 <li className="relative list-none w-[95vw] md:w-[75vw]">
 {children}
 </li>
 </div>
 );
...
export function CarouselSection({ tabs }: CarouselSectionProps) {
 ...
 <Text as="h2" variant="h2" weight="bold" className="text-[var(--color-text-primary)]">Support that fits your moment</Text>
 </div>
 ...
 current === index 
 ? "bg-[var(--color-text-primary)] text-white shadow-md shadow-[var(--color-text-primary)]/10" 
 : "bg-[var(--color-surface-warm)] text-[var(--color-text-secondary)] hover:bg-[var(--color-primary-light)] hover:text-[var(--color-text-primary)]"
 }`}
 >
 {tab.label}
 </button>
 ...
 <Slide key={tab.id}>
 {tab.id === "aicompanion" && (
 <Card variant="elevated" padding="none" className="rounded-md border-none overflow-hidden bg-[var(--color-surface-warm)] h-full shadow-sm">
 ...
 <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-white shadow-sm mb-4">
 <Icon icon="tabler:message-circle" className="w-10 h-10 text-[var(--color-primary)]" />
 </div>
 ...
 <Text as="h3" variant="h3" weight="bold" className="text-[var(--color-text-primary)] leading-tight">{beKindCTA.headline}</Text>
 <Text as="p" variant="body" className="mt-3.5 text-[var(--color-text-secondary)] leading-relaxed">{beKindCTA.description}</Text>
 <div className="mt-6 space-y-3">
 {beKindCTA.features.map((f) => (
 <div key={f} className="flex items-center gap-3">
 <Icon icon="tabler:circle-check" className="h-4 w-4 shrink-0 text-[var(--color-primary)]" />
 ...
 <div className="text-center">
 <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-white shadow-sm mb-4">
 <Icon icon="tabler:clipboard" className="w-10 h-10 text-[var(--color-primary)]" />
 </div>
 ...
 <Icon icon="tabler:circle-check" className="h-4.5 w-4.5 shrink-0 text-[var(--color-primary)] mt-1" />
 <div>
 ...
 <div className="text-center">
 <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-white shadow-sm mb-4">
 <Icon icon="tabler:user" className="w-10 h-10 text-[var(--color-primary)]" />
 </div>
 ...
 <div className="flex flex-col justify-center p-8 lg:p-12">
 <Text as="h3" variant="h3" weight="bold" className="text-[var(--color-text-primary)] leading-tight">Connect with a Counselor</Text>
 ...
 <div key={c.name} className="rounded-md bg-white border border-[var(--color-border-warm)] p-4 shadow-sm">
 <div className="flex items-center justify-between">
 <div>
 <Text as="p" variant="h6" weight="bold" className="text-[var(--color-text-primary)]">{c.name}</Text>
 <Text as="p" variant="small" className="text-[var(--color-text-secondary)]">{c.focus}</Text>
 </div>
 <Text as="p" variant="small" weight="bold" className="text-[var(--color-primary)] bg-[var(--color-primary-light)] px-3 py-1 rounded-full">{c.availability}</Text>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-white shadow-sm mb-6">
 <Icon icon="tabler:book" className="w-10 h-10 text-[var(--color-primary)]" />
 </div>
 ...
 <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-white shadow-sm mb-6">
 <Icon icon="tabler:moon" className="w-10 h-10 text-[var(--color-primary)]" />
 </div>
 ...
 className={`h-2 transition-all duration-300 rounded-full ${current === i ? "w-8 bg-[var(--color-primary)]" : "w-2 bg-[var(--color-border-warm)]"}`}
 />
 ))}
 </div>
 </div>
