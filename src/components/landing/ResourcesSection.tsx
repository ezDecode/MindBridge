...
export function ResourcesSection() {
 ...
 variant="elevated" 
 padding="none" 
 className="relative overflow-hidden rounded-md border-none bg-[var(--color-surface-warm)] w-full md:w-[90vw] lg:w-[75vw] h-auto min-h-[500px] md:min-h-[600px] shadow-sm"
 >
 ...
 <div className="flex flex-col justify-center rounded-md bg-[var(--color-primary-light)] p-6 sm:p-8 lg:p-10 shadow-sm border border-[var(--color-border-warm)]/30">
 ...
 <div key={r.title} className="flex flex-col justify-center rounded-md bg-white p-4 sm:p-5 shadow-sm border border-[var(--color-border-warm)]/40 transition-[border-color,box-shadow] duration-200 hover:border-[var(--color-border-strong)] hover:shadow-md">
